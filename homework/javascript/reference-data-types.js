...
// 변수 scores2에 10, 20을 담은 배열을 할당하고 출력한다
...
// TODO: 새로운 배열 만들기 2
// 변수 numbers4에 1, 2, 3, 4, 5를 담은 배열을 할당하고 출력한다
...
// book의 title을 출력한다
// book의 author를 출력한다
let book = { title: "책 제목", author: "작가명" }; //객체 생성 괄호는 중가로{}
console.log(book);
...
console.log(product);
product["brand"] = "삼성"; // product.brand="삼성"
console.log(product);
/* 출력 결과
