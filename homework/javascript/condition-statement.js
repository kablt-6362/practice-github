...
// TODO: 다중 조건 확인 실습
// 변수 userAge2는 22, 변수 hasLicense는 true, 변수 hasInsurance는 false로 할당한다
// userAge2가 21 이상이고 hasLicense가 true이고 hasInsurance가 true이면 "완벽한 운전자"를 출력한다
// userAge2가 21 이상이고 hasLicense가 true이면 "운전 가능"을 출력한다
// 그렇지 않으면 "운전 불가"를 출력한다
let userAge2 = 22;
let hasLicense = true;
let hasInsurance = false;
if (userAge2 >= 21 && hasLicense === true && hasInsurance === true) {
  console.log("완벽한 운전자");
} else if (userAge2 >= 21 && hasLicense === true) {
  console.log("운전 가능");
} else {
  console.log("운전 불가");
}
...
if (isActive === false) {
  ...
  if ((userType = "premium" && userPoints >= 2000)) {
    console.log("Vip 등급");
  } else if ((userType = "premium" && userPoints >= 1000)) {
    console.log("프리미엄 등급");
  } else if ((userType = "regular" && userPoints >= 1000)) {
    console.log("일반 등급");
  } else {
    console.log("신규 등급");
  }
...
// TODO: 음료 추천 시스템
// 변수 drinkType은 "coffee", 변수 userAge3는 16, 변수 isDecaf는 false로 할당한다
// drinkType이 "coffee"이고 userAge3가 18 이상이면 "커피 주문 가능"을 출력한다
// drinkType이 "coffee"이고 userAge3가 18 미만이고 isDecaf가 true이면 "디카페인 커피 가능"을 출력한다
